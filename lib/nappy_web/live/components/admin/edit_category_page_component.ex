defmodule NappyWeb.Components.Admin.EditCategoryPageComponent do
  ...
  def handle_event(
        ...
        %{"is_enabled" => is_enabled, "slug" => slug, "category_name" => category_name},
        socket
      ) do
    attrs = %{
    ...
    socket =
      socket
      |> put_flash(:info, "Succesfully updated the category")
    ...
    <div id="input-tags-hook" phx-hook="InputTags">
      ...
      >
        ...
        <div
          x-show="open"
          style="display: none"
          x-on:keydown.escape.prevent.stop={"open = false; value = #{@category.is_enabled}; document.getElementById('update-collection').reset()"}
          role="dialog"
          aria-modal="true"
          x-id="['modal-title']"
        ...
        >
          ...
          <div
            x-show="open"
            x-transition
            x-on:click={"open = false; value = #{@category.is_enabled}; document.getElementById('update-collection').reset()"}
          ...
          >
            ...
            >
              ...
              <h2 class="text-xl font-bold" x-bind:id="$id('modal-title')">
                Edit category name and visibility
              </h2>
              <!-- Content -->
              <div class="mt-4">
                <input type="hidden" name="slug" value={@category.slug} form="update-category-name" />
              ...
              <div class="mt-4 flex space-x-2 justify-center">
                ...
                <button
                  type="button"
                  x-on:click={"open = false; value = #{@category.is_enabled}; document.getElementById('update-category-name').reset()"}
          ...
          >
            ...
            >
              ...
              <div class="mt-8 flex space-x-2 justify-center">
                ...
                <button
                  type="button"
                  x-on:click="open = false; document.getElementById('update-category-thumbnail').reset()"
                  class="rounded-md text-white bg-black hover:bg-gray-900 px-5 py-2.5"
                >
                  Cancel
                </button>
